...
The spare room part 0 is some text that varies. The spare room part 0 is "You find yourself in a spare room. A normal kind of place.
 ...
 You make out a spherical safe.[if c_1 is open and there is something in the c_1] The spherical safe contains [a list of things in the c_1].[end if]".
...
Test quest0_0 with "take cuboid passkey / go south / unlock cuboid locker with cuboid passkey / open cuboid locker / insert mug into cuboid locker"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First thing I need you to do is to pick-up the cuboid passkey from the floor of the spare room. And then, make an attempt to v".
The objective part 1 is some text that varies. The objective part 1 is "enture south. Then, unlock the cuboid locker within the cookery with the cuboid passkey. And then, make absolutely sure that the cuboid locker within the cookery is ajar. After that, you can put the m".
The objective part 2 is some text that varies. The objective part 2 is "ug into the cuboid locker in the cookery. And once you've done that, you win!".
