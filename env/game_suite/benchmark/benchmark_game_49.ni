...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. An usual one. You begin to take stock of what's in the room.
...
The studio part 3 is some text that varies. The studio part 3 is " portal leading west. You need an unblocked exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just walked into a laundromat.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is " portal leading east. There is an unblocked exit to the south.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "Well, here we are in a workshop.
 ...
 You make out a stand. The stand is standard.[if there is something on the s_0] On the stand you can make out [a list of things on the s_0].[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of garbage. It would have been so cool if there was stuff on the stand.[end if]".
...
The d_0 is closed.
The description of o_0 is "The broom appears well matched to everything else here".
The printed name of o_0 is "broom".
Understand "broom" as o_0.
The o_0 is in r_1.
The description of o_2 is "The keyboard appears well matched to everything else here".
...
Test quest0_0 with "take licorice strip from stand / go north / eat licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First thing I need you to do is to take the licorice strip from the stand inside the workshop. And then, eat the licorice strip. Alright, thanks!".
