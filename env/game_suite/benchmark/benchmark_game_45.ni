...
The attic part 0 is some text that varies. The attic part 0 is "You're now in the attic. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 Look over there! a chest. You shudder, but continue examining the room.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0]. Now why would someone leave that there?[end if]".
...
The attic part 3 is some text that varies. The attic part 3 is " portal leading south. There is an exit to the west. Don't worry, it is unguarded.".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've just shown up in a sauna. You start to take note of what's in the room.
 ...
 Were you looking for a dresser? Because look over there, it's a dresser. I mean, just wow! Isn't TextWorld just the best?[if c_1 is open and there is something in the c_1] The dresser contains [a list of things in the c_1].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You make a grand eccentric entrance into a pantry.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is " portal leading north. There is an exit to the west. Don't worry, it is unguarded.".
...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A typical one.
 ...
 Look out! It's a- oh, never mind, it's just a bookshelf. You shudder, but continue examining the bookshelf. [if there is something on the s_0]You see [a list of things on the s_0] on the bookshelf.[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of junk. Hm. Oh well[end if]".
...
Test quest0_0 with "take keycard from bookshelf / go east / go north / unlock chest with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First thing I need you to do is to recover the keycard from the bookshelf. Then, go to the east. And then, make an effort to head north. Following th".
The objective part 1 is some text that varies. The objective part 1 is "at, insert the keycard into the chest inside the attic's lock to unlock it. That's it!".
