...
The attic part 1 is some text that varies. The attic part 1 is " safe in the corner.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1].[end if]".
The attic part 2 is some text that varies. The attic part 2 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The safe is empty![end if]".
...
Test quest0_0 with "go north / open safe / take shadfly from safe / go east / insert shadfly into dresser"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First off, attempt to take a trip north. With that accomplished, ens".
The objective part 1 is some text that varies. The objective part 1 is "ure that the safe within the attic is open. And then, retrieve the shadfly from the safe inside the attic. Then, take a trip east. With that over with, insert the shadfly inside the dresser in the res".
The objective part 2 is some text that varies. The objective part 2 is "troom. Once that's all handled, you can stop!".
