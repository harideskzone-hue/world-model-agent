...
The r_0 and the r_4 and the r_2 and the r_3 and the r_1 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
...
The vault part 1 is some text that varies. The vault part 1 is " display here.[if c_0 is open and there is something in the c_0] The display contains [a list of things in the c_0].[end if]".
The vault part 2 is some text that varies. The vault part 2 is "[if c_0 is open and the c_0 contains nothing] The display is empty! What a waste of a day![end if]".
The vault part 3 is some text that varies. The vault part 3 is " Oh, great. Here's a stand. [if there is something on the s_0]On the stand you can make out [a list of things on the s_0].[end if]".
The vault part 4 is some text that varies. The vault part 4 is "[if there is nothing on the s_0]But the thing hasn't got anything on it.[end if]".
The vault part 5 is some text that varies. The vault part 5 is "

 There is [if d_3 is open]an open[otherwise]a closed[end if]".
The vault part 6 is some text that varies. The vault part 6 is " Henderson's door leading west. There is an exit to the east. Don't worry, it is unblocked. You need an unblocked exit? You should try going south.".
...
The garage part 0 is some text that varies. The garage part 0 is "You are in a garage. A typical kind of place.
 ...
 You can see a table. The table is typical.[if there is something on the s_1] On the table you see [a list of things on the s_1]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The garage part 1 is some text that varies. The garage part 1 is "[if there is nothing on the s_1] But the thing hasn't got anything on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The garage part 2 is some text that varies. The garage part 2 is "

 There is [if d_3 is open]an open[otherwise]a closed[end if]".
The garage part 3 is some text that varies. The garage part 3 is " Henderson's door leading east. There is [if d_2 is open]an open[otherwise]a closed[end if]".
The garage part 4 is some text that varies. The garage part 4 is " portal leading north.".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. An usual kind of place. You begin to take stock of what's in the room.
...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. A typical kind of place. You begin to take stock of what's in the room.
...
The study part 2 is some text that varies. The study part 2 is " passageway leading south. There is an unblocked exit to the north.".
...
The shower part 1 is some text that varies. The shower part 1 is " passageway leading north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The r_0 and the r_4 and the r_2 and the r_3 and the r_1 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
The r_0 and the r_4 and the r_2 and the r_3 and the r_1 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are privately-named.
The s_0 and the s_1 are supporters.
The s_0 and the s_1 are privately-named.

The description of d_3 is "it is what it is, a Henderson's door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_3 is "Henderson's door".
Understand "Henderson's door" as d_3.
...
Test quest0_0 with "take Henderson's passkey / unlock Henderson's door with Henderson's passkey / open Henderson's door / go east / take pair of pants from stand / insert pair of pants into display"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, recover the Henderson's passkey from the floor of the garage. After that, unlock the Henderso".
The objective part 1 is some text that varies. The objective part 1 is "n's door in the garage with the Henderson's passkey. After that, make it so that the Henderson's door is opened. After that, make an effort to venture east. After that, take the pair of pants from the".
The objective part 2 is some text that varies. The objective part 2 is " stand inside the vault. And then, deposit the pair of pants inside the display within the vault. Got that? Good!".
