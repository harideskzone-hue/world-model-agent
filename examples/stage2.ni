...
The bedchamber part 2 is some text that varies. The bedchamber part 2 is " You scan the room for a bed, and you find a bed. Wow, isn't TextWorld just the best? [if there is something on the s_0]You see [a list of things on the s_0] on the bed. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The bedchamber part 3 is some text that varies. The bedchamber part 3 is "[if there is nothing on the s_0]The bed appears to be empty.[end if]".
The bedchamber part 4 is some text that varies. The bedchamber part 4 is " You make out a stand. The stand is ordinary.[if there is something on the s_1] On the stand you make out [a list of things on the s_1].[end if]".
The bedchamber part 5 is some text that varies. The bedchamber part 5 is "[if there is nothing on the s_1] Looks like someone's already been here and taken everything off it, though. This always happens![end if]".
The bedchamber part 6 is some text that varies. The bedchamber part 6 is "

 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The bedchamber part 7 is some text that varies. The bedchamber part 7 is " gateway leading east. There is an unguarded exit to the west.".
...
The study part 0 is some text that varies. The study part 0 is "Okay, so you're in a study, cool, but is it ordinary? You better believe it is. The room is well lit.

 You can make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The study part 1 is some text that varies. The study part 1 is " display nearby.[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1].[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_1 is open and the c_1 contains nothing] The display is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The workshop part 1 is some text that varies. The workshop part 1 is " gate leading north. There is [if d_2 is open]an open[otherwise]a closed[end if]".
...
The chamber part 1 is some text that varies. The chamber part 1 is " portal leading south. There is an unblocked exit to the west.".
...
The office part 0 is some text that varies. The office part 0 is "Of every office you could have sauntered into, you had to come round an usual one. Let's see what's in here.
...
The studio part 3 is some text that varies. The studio part 3 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The studio part 4 is some text that varies. The studio part 4 is " portal leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The studio part 5 is some text that varies. The studio part 5 is " gate leading south.".
...
Test quest0_0 with "take spherical latchkey from stand / unlock spherical locker with spherical latchkey / open spherical locker / take insect from spherical locker / put insect on bed"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First stop, retrieve the spherical latchkey from the stand. Then, make sure that the spherical lo".
The objective part 1 is some text that varies. The objective part 1 is "cker in the bedchamber is unlocked with the spherical latchkey. And then, open the spherical locker inside the bedchamber. And then, take the insect from the spherical locker. If you have picked up th".
The objective part 2 is some text that varies. The objective part 2 is "e insect, place the insect on the bed inside the bedchamber. That's it!".
