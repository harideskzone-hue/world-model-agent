...
The dish-pit part 3 is some text that varies. The dish-pit part 3 is " gate leading west. There is an exit to the south. Don't worry, it is unguarded.".
...
The lounge part 0 is some text that varies. The lounge part 0 is "You find yourself in a lounge. An ordinary kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The lounge part 1 is some text that varies. The lounge part 1 is " gate leading east. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. A standard kind of place. I guess you better just go and list everything you see here.

 You can see a bench. The bench is normal.[if there is something on the s_0] On the bench you see [a list of things on the s_0].[end if]".
...
The parlor part 0 is some text that varies. The parlor part 0 is "Okay, so you're in a parlor, cool, but is it ordinary? You better believe it is.
 ...
 Oh, great. Here's a locker.[if c_1 is open and there is something in the c_1] The locker contains [a list of things in the c_1]. Now that's what I call TextWorld![end if]".
...
The f_0 is in r_0.
The f_0 is edible.
The description of o_1 is "The cushion is unremarkable.".
...
Test quest0_0 with "go south / take shirt from bench / go north / insert shirt into chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First of all, make an attempt to travel south. That done, pick up the shirt from the bench inside the washroom. And then, go to the north. After that, insert".
The objective part 1 is some text that varies. The objective part 1 is " the shirt inside the chest within the dish-pit. Once that's all handled, you can stop!".
