...
The study part 1 is some text that varies. The study part 1 is "[if c_0 is open and the c_0 contains nothing] The rectangular chest is empty! This is the worst thing that could possibly happen, ever![end if]".
The study part 2 is some text that varies. The study part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a safe.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1].[end if]".
The study part 3 is some text that varies. The study part 3 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The safe is empty![end if]".
...
The steam room part 1 is some text that varies. The steam room part 1 is " gate leading south. There is an unblocked exit to the east.".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You arrive in a bedchamber. A typical one.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedchamber part 1 is some text that varies. The bedchamber part 1 is " gate leading north. You need an unblocked exit? You should try going east.".
...
Test quest0_0 with "go west / take rectangular key / go east / lock rectangular chest with rectangular key"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. Your first objective is to head west. After that, pick up the rectangular ".
The objective part 1 is some text that varies. The objective part 1 is "key from the floor of the steam room. If you can get your hands on the rectangular key, take a trip east. And then, lock the rectangular chest in the study with the rectangular key. Alright, thanks!".
