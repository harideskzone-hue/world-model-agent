...
The restroom part 1 is some text that varies. The restroom part 1 is " cabinet, which looks normal, nearby.[if c_0 is open and there is something in the c_0] The cabinet contains [a list of things in the c_0].[end if]".
...
The attic part 0 is some text that varies. The attic part 0 is "You arrive in an attic. A normal one.
 ...
 You can make out a workbench. The workbench is usual.[if there is something on the s_0] On the workbench you can see [a list of things on the s_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The attic part 1 is some text that varies. The attic part 1 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it. What's the point of an empty workbench?[end if]".
...
The s_0 is in r_1.
The description of o_0 is "The coffee cup looks to fit in here".
...
Test quest0_0 with "go south / insert coffee cup into cabinet"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound game of TextWorld! First off, if it's not too much trouble, I need you to go to the south. Following that, you can put the coffee cup inside the cabinet. Got that? Good!".
