...
Test quest0_0 with "take mouse / insert mouse into display"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing round of TextWorld! Here is your task for today. First stop, pick-up the mouse from the floor of the study. And then, put the mouse into the display. Alright, thanks!".
