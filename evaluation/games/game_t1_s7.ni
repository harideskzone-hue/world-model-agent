...
The dish-pit part 2 is some text that varies. The dish-pit part 2 is " You make out a chair. [if there is something on the s_1]You see [a list of things on the s_1] on the chair.[end if]".
...
Test quest0_0 with "take teacup from chair / put teacup on counter"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! First thing I need you to do is to recover the teacup from the chair. And then, put the teacup on the counter within the dish-pit. And once you've done".
