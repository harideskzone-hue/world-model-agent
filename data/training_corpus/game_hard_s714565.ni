...
The r_1 and the r_0 and the r_2 and the r_3 and the r_5 and the r_6 and the r_4 and the r_7 and the r_8 and the r_9 are rooms.

Understand "launderette" as r_1.
The internal name of r_1 is "launderette".
The printed name of r_1 is "-= Launderette =-".
The launderette part 0 is some text that varies. The launderette part 0 is "You've seen better launderettes, but at least this one seems pretty typical. You begin to take stock of what's here.
...
The launderette part 2 is some text that varies. The launderette part 2 is " You bend down to tie your shoe. When you stand up, you notice a type C locker.[if c_1 is open and there is something in the c_1] The type C locker contains [a list of things in the c_1].[end if]".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You are in a restroom. An ordinary one. You start to take note of what's in the room.
 ...
 You can make out a table. The table is normal.[if there is something on the s_0] On the table you can make out [a list of things on the s_0]. Now that's what I call TextWorld![end if]".
...
The restroom part 3 is some text that varies. The restroom part 3 is " gateway leading east. You need an unguarded exit? You should try going south. There is an unblocked exit to the west.".
...
The study part 0 is some text that varies. The study part 0 is "Well how about that, you are in a place we're calling a study. You can barely contain your excitement.
...
The study part 2 is some text that varies. The study part 2 is " gateway leading west. There is an unblocked exit to the south.".
...
The vault part 0 is some text that varies. The vault part 0 is "You're now in the vault.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The vault part 1 is some text that varies. The vault part 1 is " door leading west. There is an exit to the north. Don't worry, it is unguarded. There is an unblocked exit to the south.".
...
The closet part 0 is some text that varies. The closet part 0 is "You arrive in a closet. A normal kind of place. You begin to take stock of what's here.
 ...
 What's that over there? It looks like it's a stand. The stand is normal.[if there is something on the s_1] On the stand you can see [a list of things on the s_1].[end if]".
The closet part 1 is some text that varies. The closet part 1 is "[if there is nothing on the s_1] However, the stand, like an empty stand, has nothing on it. What's the point of an empty stand?[end if]".
...
The r_1 and the r_0 and the r_2 and the r_3 and the r_5 and the r_6 and the r_4 and the r_7 and the r_8 and the r_9 are rooms.
The r_1 and the r_0 and the r_2 and the r_3 and the r_5 and the r_6 and the r_4 and the r_7 and the r_8 and the r_9 are privately-named.
...
The c_0 is in r_1.
The c_0 is locked.
The description of c_1 is "The type C locker looks strong, and impossible to break. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_1 is "type C locker".
Understand "type C locker" as c_1.
...
The o_0 is in r_3.
The description of o_1 is "The Quote of the Day Calendar appears well matched to everything else here".
...
The description of o_2 is "The mop is antiquated.".
The printed name of o_2 is "mop".
Understand "mop" as o_2.
The player carries the o_2.
The description of o_3 is "The top hat appears out of place here".
...
Test quest0_0 with "go south / go east / open type C locker / take passkey from type C locker / unlock chest with passkey / open chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced session of TextWorld! Here is your task for today. First, it would be great if you could attempt to venture south. With that over with, take a trip east. And then, double".
The objective part 1 is some text that varies. The objective part 1 is "check that the type C locker in the launderette is wide open. And then, take the passkey from the type C locker. And then, check that the chest in the launderette is unlocked with the passkey. And the".
The objective part 2 is some text that varies. The objective part 2 is "n, assure that the chest inside the launderette is opened. And if you do that, you're the winner!".
