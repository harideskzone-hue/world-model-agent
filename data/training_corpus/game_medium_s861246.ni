...
The office part 1 is some text that varies. The office part 1 is "[if c_0 is open and the c_0 contains nothing] The locker is empty! What a waste of a day![end if]".
...
The office part 3 is some text that varies. The office part 3 is " usual looking rectangular chest here.[if c_1 is open and there is something in the c_1] The rectangular chest contains [a list of things in the c_1].[end if]".
The office part 4 is some text that varies. The office part 4 is "[if c_1 is open and the c_1 contains nothing] The rectangular chest is empty! What a waste of a day![end if]".
The office part 5 is some text that varies. The office part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The office part 6 is some text that varies. The office part 6 is " gateway leading west. There is an exit to the south. Don't worry, it is unguarded.".
...
The study part 0 is some text that varies. The study part 0 is "Look at that sign! What does it say? It says Welcome to the study? Well that's cool. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The workshop part 1 is some text that varies. The workshop part 1 is " hatch leading north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The chamber part 1 is some text that varies. The chamber part 1 is " suitcase.[if c_2 is open and there is something in the c_2] The suitcase contains [a list of things in the c_2]. Now why would someone leave that there?[end if]".
The chamber part 2 is some text that varies. The chamber part 2 is "[if c_2 is open and the c_2 contains nothing] The suitcase is empty, what a horrible day![end if]".
...
The description of k_1 is "The rectangular key is surprisingly heavy.".
...
Test quest0_0 with "unlock rectangular chest with rectangular key / open rectangular chest / take keycard from rectangular chest / unlock locker with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting session of TextWorld! Here is your task for today. First stop, insert the rectangular key into the rectangular chest's lock to unlock it. After that, open the rectangular c".
The objective part 1 is some text that varies. The objective part 1 is "hest. After pulling open the rectangular chest, recover the keycard from the rectangular chest in the office. And then, unlock the locker. And once you've done that, you win!".
