...
The scullery part 1 is some text that varies. The scullery part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The case is empty![end if]".
The scullery part 2 is some text that varies. The scullery part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is " gate leading south. You need an unguarded exit? You should try going east.".
...
The bar part 0 is some text that varies. The bar part 0 is "You arrive in a bar. A normal kind of place.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bar part 1 is some text that varies. The bar part 1 is " gate leading north. You don't like doors? Why not try going east, that entranceway is unguarded. There is an exit to the west. Don't worry, it is unblocked.".
...
The studio part 1 is some text that varies. The studio part 1 is " display.[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1].[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_1 is open and the c_1 contains nothing] The display is empty, what a horrible day![end if]".
...
The c_1 is in r_4.
The c_1 is closed.
The description of o_1 is "The binder looks well matched to everything else here".
...
Test quest0_0 with "go west / take sandwich from case / go east / eat sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First stop, attempt to venture west. After that, take the sandwich from the case inside the scullery. Then, eat the sandwich. And once you've done ".
