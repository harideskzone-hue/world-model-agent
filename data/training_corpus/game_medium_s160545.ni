...
The cookhouse part 1 is some text that varies. The cookhouse part 1 is " TextWorld style box.[if c_0 is open and there is something in the c_0] The TextWorld style box contains [a list of things in the c_0]![end if]".
...
The cookhouse part 4 is some text that varies. The cookhouse part 4 is " hatch leading north. There is an unguarded exit to the west.".
...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. An ordinary one.
 ...
 Look over there! a bookshelf. The bookshelf is ordinary.[if there is something on the s_0] On the bookshelf you make out [a list of things on the s_0].[end if]".
...
The study part 3 is some text that varies. The study part 3 is " passageway leading west. You need an unblocked exit? You should try going south.".
...
The studio part 0 is some text that varies. The studio part 0 is "You're now in a studio.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The studio part 1 is some text that varies. The studio part 1 is " passageway leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. An usual one. You begin to take stock of what's here.
...
Test quest0_0 with "unlock TextWorld style box with TextWorld style latchkey / open TextWorld style box / take cookie from TextWorld style box / eat cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First, it would be great if you could unlock the TextWorld style box with the TextWorld style latchkey. Once you have unlocked".
The objective part 1 is some text that varies. The objective part 1 is " the TextWorld style box, open the TextWorld style box in the cookhouse. And then, take the cookie from the TextWorld style box within the cookhouse. And then, eat the cookie. Alright, thanks!".
