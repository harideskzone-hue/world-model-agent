...
The kitchen part 4 is some text that varies. The kitchen part 4 is " gate leading east. There is an exit to the north. Don't worry, it is unguarded. There is an unguarded exit to the west.".
...
The chamber part 0 is some text that varies. The chamber part 0 is "I just think it's awesome that you're in a chamber now. You decide to start listing off everything you see in the room, as if you were in a text adventure.



 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is " gate leading west. You don't like doors? Why not try going east, that entranceway is unguarded. There is an unblocked exit to the north.".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You arrive in a standard kind of place. That is to say, you're in a bedchamber.
...
The closet part 1 is some text that varies. The closet part 1 is "[if there is nothing on the s_0]But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The workshop part 1 is some text that varies. The workshop part 1 is " hatch leading north. There is an exit to the east. Don't worry, it is unguarded. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The attic part 0 is some text that varies. The attic part 0 is "Of every attic you could have sauntered into, you had to walk into a normal one.



 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The attic part 1 is some text that varies. The attic part 1 is " hatch leading south. You need an unblocked exit? You should try going north.".
...
The c_0 is in r_2.
The c_0 is locked.
The description of f_0 is "The salad looks delectable.".
...
The o_2 is in r_4.
The description of o_3 is "The mat appears out of place here".
...
Test quest0_0 with "go south / go east / go north / take salad / go south / eat salad"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Your first objective is to try to move south. With that over with, make an attempt to travel east.".
The objective part 1 is some text that varies. The objective part 1 is " Then, go north. And then, lift the salad from the floor of the closet. And then, eat the salad. Alright, thanks!".
