...
The launderette part 1 is some text that varies. The launderette part 1 is "[if c_0 is open and the c_0 contains nothing] The trunk is empty! What a waste of a day![end if]".
...
Test quest0_0 with "go south / insert worm into trunk"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First step, attempt to move south. Next, you can put the worm into the trunk. Alright, thanks!".
